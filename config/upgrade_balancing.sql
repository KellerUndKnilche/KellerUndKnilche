...
(36, 'Dämonenvertrag', 500000, 'prozent', 10, 'boost', 5),
(37, 'Blutschwur der Faulen', 1000000, 'prozent', 25, 'boost', 5),
(38, 'Höllischer Halbtagsjob', 2000000, 'prozent', 50, 'boost', 5),
(39, 'Dämonen-Aufzucht', 4000000, 'prozent', 100, 'boost', 5),
(40, 'Inferno-Bindung', 8000000, 'prozent', 200, 'boost', 5),
(41, 'Teufelsbeschwörung', 16000000, 'prozent', 500, 'boost', 5),
(42, 'Dämonen-Energieschub', 32000000, 'prozent', 1000, 'boost', 5),

-- Höllenhundebrigade Booster (+10%, +25%, +50%, +100%, +200%, +500%, +1000%)
(43, 'Höllenhund-Rudelschule', 5000000, 'prozent', 10, 'boost', 6),
(44, 'Feueratem-Training', 10000000, 'prozent', 25, 'boost', 6),
(45, 'Infernaler Aufmarsch', 20000000, 'prozent', 50, 'boost', 6),
(46, 'Hundekommando-Feuer', 40000000, 'prozent', 100, 'boost', 6),
(47, 'Höllenhund-Renntraining', 80000000, 'prozent', 200, 'boost', 6),
(48, 'Feuer-Pulverisierung', 160000000, 'prozent', 500, 'boost', 6),
(49, 'Teufelsfeuer-Angriff', 320000000, 'prozent', 1000, 'boost', 6),

-- Schattenkaiser Booster (+10%, +25%, +50%, +100%, +200%, +500%, +1000%)
(50, 'Schattenmeisterei', 50000000, 'prozent', 10, 'boost', 7),
(51, 'Dunkelheitsdoktorat', 100000000, 'prozent', 25, 'boost', 7),
(52, 'Herrschaft des Grauens', 200000000, 'prozent', 50, 'boost', 7),
(53, 'Todeshauch', 400000000, 'prozent', 100, 'boost', 7),
(54, 'Dunkle Verschmelzung', 800000000, 'prozent', 200, 'boost', 7),
(55, 'Schattenschwemme', 1600000000, 'prozent', 500, 'boost', 7),
(56, 'Schreckensherrschaft', 3200000000, 'prozent', 1000, 'boost', 7),
