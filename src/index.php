...
<main class="container">
    ...
    <div class="welcome-panel mt-4">
        ...
        <a href="/registrierung" class="btn btn-primary welcomeButton">Zum Dungeonpakt – Jetzt registrieren</a>
        <a href="/login" class="btn btn-secondary welcomeButton">Rückkehr ins Verlies – Anmelden</a>
    </div>
    <?php endif; ?>
